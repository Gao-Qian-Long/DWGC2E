...
public sealed partial class WorkerApiClient : IBillingClient
{
 ...
 public Task<BillingOrder> CheckoutAsync(string planId,string channel,string key,CancellationToken ct=default)=>BillingRequest<BillingOrder>("/v1/billing/checkout",ct,new {planId,channel},key,expectedPlanId:planId,expectedChannel:channel);
